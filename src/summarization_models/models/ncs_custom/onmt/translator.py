...
import numpy as np
import torch
from summarization_models.models.ncs_custom.vocabulary.Vocabulary import Vocabulary

from .beam_search import BeamSearch

# from onmt.constants import DefaultTokens, ModelTask
from .CopyGenerator import collapse_copy_scores
from .misc import report_matrix, set_random_seed, tile
...
class Inference(object):
    ...
    def __init__(
        ...
        source_vocabulary: Vocabulary.gpu = -1,
        n_best=1,
        min_length=0,
        max_length=100,
        ratio=0.0,
        ...
        self.model = model
        self._tgt_vocab = target_vocabulary
        self._tgt_eos_idx = target_vocabulary.eos_idx
        self._tgt_pad_idx = target_vocabulary.pad_idx
        self._tgt_bos_idx = target_vocabulary.sos_idx
        self._tgt_unk_idx = target_vocabulary.unk_idx
        self._tgt_vocab_len = len(target_vocabulary)
    ...
    def _decode_and_generate(
        ...
        # here we have scores [tgt_len x batch, vocab] or [beamxbatch, vocab]
