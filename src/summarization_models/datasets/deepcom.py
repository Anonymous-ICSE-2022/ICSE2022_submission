...
_DESCRIPTION = "EMSE-Deepcom Dataset"
...
_URL = "https://storage.googleapis.com/summarization-datsets/deepcom.tar.gz"


@dataclass
class DeepcomDatsetConfig(datasets.BuilderConfig):
...
class EMSEDeepcom(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIG_CLASS = DeepcomDatsetConfig
    BUILDER_CONFIGS = [
        DeepcomDatsetConfig(name="default", description="default config")
    ]
