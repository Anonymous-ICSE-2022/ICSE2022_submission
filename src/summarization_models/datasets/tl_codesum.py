...
_URL = "https://storage.googleapis.com/summarization-datsets/tlcodesum.tar.gz"


@dataclass
class TLCodeSumDatsetConfig(datasets.BuilderConfig):
...
class TLCodeSum(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIG_CLASS = TLCodeSumDatsetConfig
    BUILDER_CONFIGS = [
        TLCodeSumDatsetConfig(name="default", description="default config")
    ]
